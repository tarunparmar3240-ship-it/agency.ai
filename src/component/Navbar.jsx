...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    ...
    className="flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 py-4 sticky top-0 z-20 backdrop-blur-xl font-medium dark: bg-white/50 dark:bg-gray-900/70">
      <img
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <img
          ...
          alt="menu-icon"
          className="w-8 text-white right-4  sm:hidden"
